...
HD_PWD='C:/Users/m_rah/Desktop/assignments/assignment_3/odd_even_sort_hw/odd_even_sort_hw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_odd_even_sort.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_odd_even_sort.tcl
